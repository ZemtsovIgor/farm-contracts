...
contract TFTToken is ITFT, ERC20Votes, Ownable {
    ...
    constructor() ERC20("TBCC Finance Token", "TFT") ERC20Permit("TBCC Finance Token") {}
     ...
     */
    function transferOwnership(address newOwner) public override(ITFT, Ownable) virtual onlyOwner {
